...
The system combines real-world credential data extracted from Corilla platform available at https://corilla.coriyase.com/, with synthetic augmentation to model evolving fraud patterns involving students, institutions, certificates, and verifiers.
